...
float Settings::GetDamageMult(RE::ActorValue av)
{
	switch (av)
	{
...
float Settings::GetDamageLimit(RE::ActorValue av)
{
	switch (av)
	{
	case RE::ActorValue::kHealth:
...
void Settings::SetDamageMult(RE::ActorValue av, float mult)
{
	switch (av)
	{
	case RE::ActorValue::kHealth:
...
void Settings::SetDamageLimit(RE::ActorValue av, float limit)
{
	switch (av)
	{
	case RE::ActorValue::kHealth:
...
static float HealthDamageMult;
static float HealthDamageLimit;
static float StaminaDamageMult;
static float StaminaDamageLimit;
static float MagickaDamageMult;
static float MagickaDamageLimit;
